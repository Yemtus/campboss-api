      ...
      html: `
        <div style="font-family:Inter,Arial,sans-serif;max-width:600px;margin:0 auto;background:#0f172a;color:#e2e8f0;padding:2rem;border-radius:12px;">
          <div style="display:flex;align-items:center;gap:0.75rem;margin-bottom:2rem;">
            <div style="width:40px;height:40px;background:linear-gradient(135deg,#f97316,#dc2626);border-radius:9px;display:flex;align-items:center;justify-content:center;font-size:20px;">⚓</div>
            <span style="font-size:1.2rem;font-weight:800;color:#fff;">Camp Boss</span>
          </div>
          ...
          <p style="color:#94a3b8;margin-bottom:1rem;">The demo is pre-loaded with realistic offshore catering data so you can explore every feature straight away. Data resets automatically every midnight.</p>

          <p style="color:#94a3b8;margin-bottom:2rem;">If you have any questions or want a personalised walkthrough, send us a WhatsApp message and we will get back to you within 24 hours.</p>

          <a href="https://wa.me/2348034765266?text=Hi,%20I%20just%20got%20my%20Camp%20Boss%20demo%20access%20and%20would%20like%20a%20walkthrough." style="display:inline-block;background:linear-gradient(135deg,#f97316,#ea580c);color:#fff;padding:0.85rem 2rem;border-radius:8px;font-weight:700;text-decoration:none;margin-bottom:2rem;">Chat With Us on WhatsApp</a>
